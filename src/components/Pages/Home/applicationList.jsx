...
const ApplicationList = () => {
    const getDetails = (key, value) => {
        return <div>
            <Fonts variant={VARIANTS.labels2}>
                {key}
            </Fonts>
            <Fonts variant={VARIANTS.labels3}>
                {value}
            </Fonts>
        </div>
    }
        ...
        return ApplicationArray.map((a) => (
            <div className={styles.userDetailContainer}>
                ...
                <div className={styles.progressbar}>
                    <ProgressBar percent={30} showInfo={false} className="userSkill" />
                </div>
    ...
    return (
        <div><Carousal content={getContent()} /></div>
    )
}
